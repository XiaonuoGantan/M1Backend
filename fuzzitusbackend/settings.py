# Django settings for fuzzitusbackend project.
...
SECRET_KEY = 'o@k4g80v-4u_sk)ps=ydrax4p9s+(8))!+w)vb0j%k3qr8-wza'
...
ROOT_URLCONF = 'fuzzitusbackend.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fuzzitusbackend.wsgi.application'
...
### django-pipeline asset group specifications ###
PIPELINE_CSS = {
    'bootstrap': {
        'source_filenames': (
